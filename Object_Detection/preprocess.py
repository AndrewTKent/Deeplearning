...
def pull_anchors():
    return [[[116,90], [156,198], [373,326]], [[30,61], [62,45], [59,119]], [[10,13], [16,30], [33,23]]]
...
def detect_image(image_pil, obj_thresh, nms_thresh, darknet, net_h, net_w, anchors, labels):
...
def detect_video(video_path, output_path, obj_thresh, nms_thresh, darknet, net_h, net_w, anchors, labels):
